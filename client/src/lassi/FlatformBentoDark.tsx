  ...
  return (
    <Card label="Analytics" className={`border-r ${border}`}>
      ...
      <div className="relative mt-6 h-32.5">
        ...
        <div className="absolute left-[42%] top-0 bg-[#111] border border-white/10 rounded-xl px-4 py-3 shadow-2xl w-52.5">
...
export default function FeatureGridDark() {
  return (
    <section className="bg-black min-h-screen px-4 py-16 sm:px-6 lg:px-8">
